...
public class CatalogController {
	...
	@FXML
	private javafx.scene.layout.Region flower_sale_underline1;

	@FXML
	private javafx.scene.layout.Region flower_sale_underline2;

	@FXML
	private javafx.scene.layout.Region flower_sale_underline3;

	@FXML
	private javafx.scene.layout.Region flower_sale_underline4;

	@FXML
	private javafx.scene.layout.Region flower_sale_underline5;

	@FXML
	private javafx.scene.layout.Region flower_sale_underline6;
	...
	private void updatePricingLabels(Product product, Label priceBadge, Text priceBefore, Label priceAfter, Label promoBadge,
									 javafx.scene.layout.Region saleUnderline) {
		if (product == null) {
			return;
		}
		...
		saleUnderline.setVisible(hasPromotion);
		saleUnderline.setManaged(hasPromotion);
	...
	public void updateFields(int mode)
	{
		...
		else
		{
			...
			flower_sale_underline1.setVisible(false);
			flower_sale_underline2.setVisible(false);
			flower_sale_underline3.setVisible(false);
			flower_sale_underline4.setVisible(false);
			flower_sale_underline5.setVisible(false);
			flower_sale_underline6.setVisible(false);
			flower_sale_underline1.setManaged(false);
			flower_sale_underline2.setManaged(false);
			flower_sale_underline3.setManaged(false);
			flower_sale_underline4.setManaged(false);
			flower_sale_underline5.setManaged(false);
			flower_sale_underline6.setManaged(false);
			...
			if(CatalogENDIndex - CatalogSTARTIndex > 0)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex), flower_price1, flower_price_before1, flower_price_after1,
						flower_promo1, flower_sale_underline1);
			...
			if (CatalogENDIndex - CatalogSTARTIndex > 1)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex + 1), flower_price2, flower_price_before2,
						flower_price_after2, flower_promo2, flower_sale_underline2);
			...
			if (CatalogENDIndex - CatalogSTARTIndex > 2)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex + 2), flower_price3, flower_price_before3,
						flower_price_after3, flower_promo3, flower_sale_underline3);
			...
			if (CatalogENDIndex - CatalogSTARTIndex > 3)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex + 3), flower_price4, flower_price_before4,
						flower_price_after4, flower_promo4, flower_sale_underline4);
			...
			if (CatalogENDIndex - CatalogSTARTIndex > 4)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex + 4), flower_price5, flower_price_before5,
						flower_price_after5, flower_promo5, flower_sale_underline5);
			...
			if (CatalogENDIndex - CatalogSTARTIndex > 5)
			{
				...
				updatePricingLabels(displayProducts.get(CatalogSTARTIndex + 5), flower_price6, flower_price_before6,
						flower_price_after6, flower_promo6, flower_sale_underline6);
	...
	void initialize() throws MalformedURLException {
		...
		assert flower_sale_underline1 != null : "fx:id=\"flower_sale_underline1\" was not injected: check your FXML file 'Catalog.fxml'.";
		assert flower_sale_underline2 != null : "fx:id=\"flower_sale_underline2\" was not injected: check your FXML file 'Catalog.fxml'.";
		assert flower_sale_underline3 != null : "fx:id=\"flower_sale_underline3\" was not injected: check your FXML file 'Catalog.fxml'.";
		assert flower_sale_underline4 != null : "fx:id=\"flower_sale_underline4\" was not injected: check your FXML file 'Catalog.fxml'.";
		assert flower_sale_underline5 != null : "fx:id=\"flower_sale_underline5\" was not injected: check your FXML file 'Catalog.fxml'.";
		assert flower_sale_underline6 != null : "fx:id=\"flower_sale_underline6\" was not injected: check your FXML file 'Catalog.fxml'.";
